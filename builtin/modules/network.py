...
# ============================================================================
# NETWORK TOOLKIT (inlined from backend/nan_itself/utils/network.py)
#
# Network self-perception toolkit: deterministic facts only.
#
# Same disciplines as the system toolkit:
#
...
def wifi_ssid() -> str | None:
    """Moved here from the system toolkit (network owns the link)."""
    system = platform.system()
